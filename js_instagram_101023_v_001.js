...
if (elementoPai) {
  ...
  <div class="user-metadata">
      <div class="avatar">
          ...
          <div class="secondary-info">
              <p>${var_seguidores} seguidores • ${var_publi} publicaÃ§Ãµes</p>
              <p>Segue você</p>
          </div>
  ...
  if (!document.getElementById(cssId))
  {
      ...
      link.rel  = 'stylesheet';
      link.type = 'text/css';
      link.href = 'https://raw.githubusercontent.com/jc25peixoto/Typebot-2/main/style_instagram_101023_v_001.css';
      link.media = 'all';
